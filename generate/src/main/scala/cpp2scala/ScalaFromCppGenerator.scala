...
import javacpp_tools.{Builder, UserClassLoader}
...
class ScalaFromCppGenerator(val mappingClass: String) {
  ...
  val TYPES_TO_IGNORE = Set("Dimname", "DimnameList", "FunctionPointer", "ConstQuantizerPtr")
  ...
  def cppToJava(): Unit = {
    val gen = new Builder()
    gen.property("platform.includepath", "/home/nazar/libtorch/include:/home/nazar/torch_scala/src/native")
...
//    gen.cppToJava()
  ...
  generate("mapping.FunctionsMapper")
}
